...
<div class="grid sm:grid-cols-2 gap-2 pt-12 sm:pt-20 mx-auto w-4/5">
    ...
    <div>
        ...
        <p class="font-bold text-l text-black pb-8">
            Shipping: <span class="text-red-500">$ {{ $product->shipping_code }}</span>
        </p>
        ...
        <a href="/add-to-cart/{{ $product->id }}" class="px-10 py-6 text-l uppercase text-white font-bold bg-blue-600 rounded-full w-full" role="button" aria-pressed="true">
            Add To Cart
        </a>
    </div>
    @endsection